...
public class LeechChestEntityRenderer<T extends BlockEntity & ChestAnimationProgress> extends ChestBlockEntityRenderer<T> {

    private final ModelPart chestLid;
    private final ModelPart chestBottom;
    private final ModelPart chestLock;

    public LeechChestEntityRenderer(BlockEntityRendererFactory.Context context) {
        super(context);
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        if (block instanceof LeechChestBlock) {
            ...
            SpriteIdentifier spriteIdentifier = BGRendering.LEECH_CHEST_SPRITE;
