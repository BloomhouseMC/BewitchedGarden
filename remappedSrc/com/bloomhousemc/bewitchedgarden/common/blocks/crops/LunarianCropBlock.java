package com.bloomhousemc.bewitchedgarden.common.blocks.crops;
...
public class LunarianCropBlock extends CropBlock {
    ...
    public LunarianCropBlock(Settings settings) {
        super(settings);
    }

    protected ItemConvertible getSeedsItem() {
        return BGObjects.LUNARIAN_SEEDS;
    }
