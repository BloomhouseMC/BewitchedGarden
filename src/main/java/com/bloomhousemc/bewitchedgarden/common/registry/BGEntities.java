...
public class BGEntities {
    ...
    public static final EntityType<BackpackEntity> BACKPACK_ENTITY = create("backpack_entity", FabricEntityTypeBuilder.<BackpackEntity>create(SpawnGroup.MISC, BackpackEntity::new).dimensions(EntityDimensions.fixed(0.6F, 1.8F)).build());
    ...
    public static void init() {
        ...
        FabricDefaultAttributeRegistry.register(BACKPACK_ENTITY, BackpackEntity.createAttributes());
        /*
