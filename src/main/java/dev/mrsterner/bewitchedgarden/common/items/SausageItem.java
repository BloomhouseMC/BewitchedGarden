package dev.mrsterner.bewitchedgarden.common.items;

import dev.mrsterner.bewitchedgarden.common.blocks.SausageBlock;
...
public class SausageItem extends Item {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if(context.getWorld().getBlockState(pos).getBlock() instanceof SausageBlock){
            ...
            context.getWorld().setBlockState(context.getBlockPos().add(context.getSide().getVector()), BGObjects.SAUSAGE.getDefaultState());
        }
        return ActionResult.PASS;
    }
}
