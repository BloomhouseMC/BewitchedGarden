...
import dev.mrsterner.bewitchedgarden.common.blocks.*;
import dev.mrsterner.bewitchedgarden.common.blocks.blockentity.SausageBlockEntity;
import dev.mrsterner.bewitchedgarden.common.blocks.snares.SnareBlock;
import dev.mrsterner.bewitchedgarden.common.blocks.snares.TeleportationSnareBlock;
import dev.mrsterner.bewitchedgarden.common.items.SausageItem;
...
import static dev.mrsterner.bewitchedgarden.common.registry.BGFoodComponents.*;
...
public class BGObjects {
    ...
    private static Item.Settings gen() {
        return new Item.Settings().group(BewitchedGarden.WITCHESKITCHEN_GROUP);
    }
