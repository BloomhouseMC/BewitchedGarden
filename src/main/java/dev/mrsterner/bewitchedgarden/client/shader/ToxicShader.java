package dev.mrsterner.bewitchedgarden.client.shader;
...
public class ToxicShader implements PostWorldRenderCallback, ServerTickEvents.StartWorldTick{
    ...
    public ManagedShaderEffect shader = ShaderEffectManager.getInstance().manage(new Identifier("witcheskitchen:shaders/post/toxic.json"), shader -> {
